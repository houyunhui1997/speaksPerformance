...
const updateTopicListTop = () => {
  ...
  const currentScale = Math.max(stageScale.value, 0.0001)
  const bottomInPage = (profileRect.bottom - pageRect.top) / currentScale
...
<template>
  <div class="page">
    <main class="author-page" :style="{ backgroundImage: `url(${bgImage})` }">
      <div class="author-page__viewport">
        <div
          ref="pageRef"
          class="author-page__stage"
