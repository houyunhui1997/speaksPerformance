...
import arrowImage from '@/assets/footprint/h5/arrow.png'
import bgImage from '@/assets/footprint/h5/bg.png'
import textImg from '@/assets/footprint/h5/text1.png'
import juxing from '@/assets/footprint/h5/juxing.png'
import didian from '@/assets/footprint/h5/didian.png'
...
const placeLabel = (baseX, baseY, boxW, boxH, seed, placed, canvasW, canvasH, cityId, dx, dy) => {
  ...
  if (cityConfig) {
    ...
    const minSafeDist = Math.max(boxW, boxH) * 0.8
