...
// Topic
import tpBg from '@/assets/topic/web/topic-bg.png'
import tpCardMd from '@/assets/topic/web/topic-card-md.png'
import tpCardXl from '@/assets/topic/web/topic-card-xl.png'
import tpCardLg from '@/assets/topic/web/topic-card-lg.png'
import tpCardSm from '@/assets/topic/web/topic-card-sm.png'
import tpCardXs from '@/assets/topic/web/topic-card-xs.png'
// Topic Author
import authListBg from '@/assets/topic/web/list-bg.png'
import authDefaultAvatar from '@/assets/topic/web/defaultAvatar.jpg'
